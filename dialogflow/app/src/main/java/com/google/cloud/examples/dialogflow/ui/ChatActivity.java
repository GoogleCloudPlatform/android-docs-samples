...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tts = this.getIntent().getBooleanExtra("tts", false);
        knowledge = this.getIntent().getBooleanExtra("knowledge", false);
        sentiment = this.getIntent().getBooleanExtra("sentiment", false);
