...
import com.google.cloud.android.dialogflow.ui.AudioIndicatorView;
import com.google.cloud.android.dialogflow.ui.HistoryAdapter;
import com.google.cloud.android.dialogflow.ui.InputHelper;
import com.google.cloud.android.dialogflow.ui.MessageDialogFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    private final ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder binder) {
            mDialogflowService = DialogflowService.from(binder);
            mDialogflowService.addListener(mSpeechServiceListener);
        }

        @Override
        public void onServiceDisconnected(ComponentName componentName) {
            mDialogflowService = null;
        }

    };

    private DialogflowService.Listener mSpeechServiceListener
            = new DialogflowService.Listener() {
        ...
        mInputHelper = new InputHelper((EditText) findViewById(R.id.text),
            ...
            public void onText(String text) {
                if (mDialogflowService != null) {
                    mDialogflowService.detectIntentByText(text);
                }
            }
            ...
            public void onVoiceStart() {
                if (mDialogflowService != null) {
                    mDialogflowService.startDetectIntentByVoice(mInputHelper.getSampleRate());
                }
            }
            ...
            public void onVoice(byte[] data, int size) {
                if (mDialogflowService != null) {
                    mDialogflowService.detectIntentByVoice(data, size);
                }
            }
            ...
            public void onVoiceEnd() {
                if (mDialogflowService != null) {
                    mDialogflowService.finishDetectIntentByVoice();
                }
            }
    ...
    protected void onStart() {
        ...
        bindService(new Intent(this, DialogflowService.class), mServiceConnection,
                BIND_AUTO_CREATE);
    }
    ...
    protected void onStop() {
        ...
        if (mDialogflowService != null) {
            mDialogflowService.removeListener(mSpeechServiceListener);
