...
import com.google.cloud.android.dialogflow.TestUtils;
...
public class DialogflowServiceTest {
    ...
    public void setUp() throws TimeoutException {
        mService = DialogflowService.from(serviceRule.bindService(
                new Intent(InstrumentationRegistry.getTargetContext(), DialogflowService.class)));
